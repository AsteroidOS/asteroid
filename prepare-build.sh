...
# Prepare bitbake
    ...
    clone_dir src/oe-core              https://github.com/openembedded/openembedded-core.git sumo
    clone_dir src/oe-core/bitbake      https://github.com/openembedded/bitbake.git           1.38
    clone_dir src/meta-openembedded    https://github.com/openembedded/meta-openembedded.git sumo
    clone_dir src/meta-qt5             https://github.com/meta-qt5/meta-qt5                  master
    clone_dir src/meta-smartphone      https://github.com/shr-distribution/meta-smartphone   sumo
